...
must_haves:
  truths:
    ...
    # Note: WebSocket reconnection (RTCM-06) server-side support is in 03-01 (subscribe message handler).
    # Client reconnection logic (auto-reconnect with backoff, auto-resubscribe) is Phase 6 Frontend work.
  artifacts:
