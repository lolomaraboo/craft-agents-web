...
must_haves:
  truths:
    - "OAuth plugin registers @fastify/oauth2 and @fastify/cookie"
    - "State manager tracks state -> sessionId mapping with 5-minute expiry"
    - "TypeBox schemas validate OAuth callback query parameters"
  artifacts:
